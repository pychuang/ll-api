# -*- coding: utf-8 -*-
#
# ll-challenge documentation build configuration file, created by
...
htmlhelp_basename = 'll-challengedoc'
...
latex_documents = [
  ('index', 'll-challenge.tex', u'll-challenge Documentation',
   u'Krisztian Balog, Liadh Kelly, Anne Schuth', 'manual'),
]
