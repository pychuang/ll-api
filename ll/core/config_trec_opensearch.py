...
config = {
    "KEY_LENGTH": 32,
    "PASSWORD_LENGHT": 8,
    "EMAIL_FROM": 'organizers@trec-open-search.net',
    "SEND_EMAIL": True,
    "COMPETITION_NAME": "TREC OpenSearch",
    "URL_WEB": "http://trec-open-search.net",
    "URL_API": "http://api.trec-open-search.net/api",
    "URL_DASHBOARD": "http://dashboard.trec-open-search.net",
    "URL_DOC": "http://doc.trec-open-search.net",
